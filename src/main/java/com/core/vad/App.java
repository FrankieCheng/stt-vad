...
public class App {
  ...
  private static final String EXAMPLE_WAV_FILE = "/Users/hongbocheng/Downloads/xiaomi-demo.wav";
  ...
  private static final int MIN_SILENCE_DURATION_MS = 1000;
  ...
  public static void fromByteArray() throws OrtException {
    SileroVADSpeechDetect sileroVADSpeechDetect = new SileroVADSpeechDetect(MODEL_PATH, THRESHOLD, THRESHOLD, SAMPLE_RATE,
        MIN_SILENCE_DURATION_MS, SPEECH_PAD_MS);
    // sileroVADSpeechDetect.apply();
  }
}